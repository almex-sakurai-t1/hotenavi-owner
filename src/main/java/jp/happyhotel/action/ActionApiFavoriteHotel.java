...
public class ActionApiFavoriteHotel extends BaseAction
{
    ...
    static String           recordsNotFound4 = "必須パラメータがありません";                // 必須パラメータの不足
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response)
    {
        ...
        {
            Logging.error( "[ActionApiFavoriteSearch.execute() ] Exception:", exception );
            ...
            {
                Logging.error( "[ActionApiFavoriteSearch response]Exception:" + e.toString() );
            }
        }
        finally
        {
