...
import jp.happyhotel.others.GenerateXmlGallery;
...
public class ActionGalleryFlashList extends BaseAction
{

    private RequestDispatcher requestDispatcher = null;

    /**
     * ホテルのギャラリー画像の一覧をFlashで表示する
     * 
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response)
    {
        ...
        final String actPathFlash = "search/galleryFlashList.act";
        ...
        try
        {
            ...
            paramFull = paramFull + "&" + paramUidLink;
            {
                ...
                if ( CheckString.numCheck( paramHotelId ) && CheckString.numCheck( paramPage ) )
                {
                    ...
                    // xmlファイルを作成
                    XMLFilePass = GenerateXmlGallery.GenerateXml( hotelId, paramFull, pageNum, currentNum, termNo, carrierFlag, actPathFlash, paramBefore, Integer.parseInt( paramCategory ) );
