...
import jp.happyhotel.others.GenerateXmlRoom1;
...
public class ActionRoomFlashList extends BaseAction
{

    private RequestDispatcher requestDispatcher = null;

    /**
     * ホテルの部屋画像の一覧をFlashで表示する
     * 
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response)
    {
        ...
        String userAgent = "";
        String errCode = "";
        final String actPathFlash = "search/area/roomFlashList.act";
        ...
        try
        {
            ...
            paramFull = paramFull + "&" + paramUidLink;
            {
                ...
                if ( CheckString.numCheck( paramHotelId ) && CheckString.numCheck( paramPage ) )
                {
                    ...
                    // xmlファイルを作成
                    XMLFilePass = GenerateXmlRoom1.GenerateXml( hotelId, paramFull, pageNum, currentNum, termNo, carrierFlag, actPathFlash, paramBefore );
