...
import jp.happyhotel.owner.FormOwnerRsvArrivalOptionList;
import jp.happyhotel.owner.FormOwnerRsvList;
import jp.happyhotel.owner.LogicOwnerRsvArrivalOptionList;
...
public class ActionOwnerRsvArrivalOptionList extends BaseAction
{
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response)
    {
        ...
        FormOwnerRsvArrivalOptionList dsp0; // form
        LogicOwnerRsvArrivalOptionList lgLPC; // logic
        dsp0 = new FormOwnerRsvArrivalOptionList();
        lgLPC = new LogicOwnerRsvArrivalOptionList();
        ...
        try
        {
            ...
            request.setAttribute( "FORM_OwnerRsvArrivalOptionList", dsp0 );
            strCarrierUrl = "owner_rsv_arrival_option_list.jsp";
     ...
     * @param frm
     */
    public void getDspHeader(HttpServletRequest request, FormOwnerRsvArrivalOptionList frm)
    {
        // 画面の値を取得
