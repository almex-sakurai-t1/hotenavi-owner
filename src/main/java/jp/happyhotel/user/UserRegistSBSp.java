 ...
 */
public class UserRegistSBSp implements Serializable
{
    ...
    public boolean registPay(HttpServletRequest request)
    {
        ...
        cookieSp = SelectCookie.getCookie( request, "hhsbhappy" );
        ...
        if ( retSp != false )
        {
            ...
            try
            {
                ...
                if ( ret != false )
                {
                    ...
                    if ( ret != false )
                    {
                        ...
                        dus.setOpenId( suid );
                        dus.setCarrierKind( DataUserSp.SOFTBANK );
            ...
            {
                Logging.info( "[UserRegistSBSp.registPay] Exception=" + e.toString() );
            }
            finally
            {
            }
    ...
    public boolean secession(HttpServletRequest request)
    {
        ...
        if ( retSp != false )
        {
            try
            {
                ...
                {
                    Logging.info( "[UserRegistSBSp.secession]:" + "userBasic noData" );
