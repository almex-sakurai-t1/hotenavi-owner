...
public class DocomoProcessor implements Serializable
{
    /**
     *
     */
     ...
     */
    public DocomoProcessor(ConsumerManager cManager, String strRealm, String strReturnTo)
    {
        manager = cManager;
        realm = strRealm;
            ...
            String identifier) throws Exception
    {
        ...
        try
        {
            ...
            // セッションマネージャーに追加
            SessionManager.addSession( SES_KEY_DISCOVERY_INFO, discoveryInfomation );
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher( "/phone/mypage/docomo/docomo_formpost.jsp" );
     ...
     * @throws Exception 例外.
     */
    public Map doVerifyResponse(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        try
        {
            ...
            URL url = new URL( "https://i.mydocomo.com/oid/auth" );
            ...
            if ( verified != null )
            {
                ...
                // 属性情報を取得する
                atterMap = DocomoGetAttributeUtil.get( verified.getIdentifier(), authSuccess.getNonce(), kind );
            }
            Logging.info( "end process." );
            return atterMap;
        }
