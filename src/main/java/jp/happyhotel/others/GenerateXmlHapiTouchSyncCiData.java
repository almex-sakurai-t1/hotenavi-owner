 ...
 * XMLハピタッチ情報
 */
public class GenerateXmlHapiTouchSyncCiData extends WebApiResultBase
{
    // タグ名
    ...
    protected void initXmlNodeInfo()
    {
        ...
        XmlTag.setParent( ciData, userId );
        XmlTag.setParent( ciData, point );
        XmlTag.setParent( ciData, amountRate );
        XmlTag.setParent( ciData, roomNo );
        XmlTag.setParent( ciData, usePoint );
        XmlTag.setParent( ciData, amount );
        XmlTag.setParent( ciData, slipNo );
        XmlTag.setParent( ciData, ciStatus );
        XmlTag.setParent( ciData, userType );
        XmlTag.setParent( ciData, delFlag );
        XmlTag.setParent( ciData, rsvNo );
        XmlTag.setParent( ciData, useTempFlag );
        XmlTag.setParent( ciData, appStatus );

        if ( employeeList != null )
        {
            for( int i = 0 ; i < employeeList.size() ; i++ )
            {
                this.employeeList.get( i ).setRootNode( ciData );
