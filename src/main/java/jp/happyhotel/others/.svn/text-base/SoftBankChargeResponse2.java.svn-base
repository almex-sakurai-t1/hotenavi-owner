...
@XmlRootElement(name = "ExecuteBillingDemandResponse")
public class SoftBankChargeResponse2 {
    ...
    @XmlElement(required = true)
    protected BigInteger purchaseDay;
    @XmlElement(required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "NCName")
    ...
    /**
     * Gets the value of the purchaseDay property.
     *
     * @return
     *     possible object is
     *     {@link BigInteger }
     *
     */
    public BigInteger getPurchaseDay() {
        return purchaseDay;
    }

    /**
     * Sets the value of the purchaseDay property.
     *
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *
     */
    public void setPurchaseDay(BigInteger value) {
        this.purchaseDay = value;
    }
