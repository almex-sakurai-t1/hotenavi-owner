/*
 * @(#)SearchHotelStation.java 1.00 2007/07/18 Copyright (C) ALMEX Inc. 2007 駅別ホテル取得クラス
 */
 ...
 */
public class SearchHotelStation implements Serializable
{
    ...
    private DataMapPoint      m_stationInfo;
    private int[]             m_hotelIdList;

    /**
     * データを初期化します。
     */
    public SearchHotelStation()
    {
        m_hotelCount = 0;
        m_hotelAllCount = 0;
    }
    ...
    /** 駅情報取得 **/
    public DataMapPoint getStationInfo()
    {
    ...
    public boolean getHotelList(String routeId, int countNum, int pageNum)
    {
        ...
        {
            Logging.error( "[SearchHotelStation.getHotelList] Exception=" + e.toString() );
            return(false);
        }
        finally
        {
        ...
        // 駅情報の取得
        this.m_stationInfo = new DataMapPoint();
        this.m_stationInfo.getData( routeId );
