 ...
 * 到着予定一覧 Formクラス
 */
public class FormOwnerRsvArrivalAssignList
{
    //
    ...
    private ArrayList<Integer> numAdultList       = new ArrayList<Integer>(); // 大人人数
    private ArrayList<Integer> numChildList       = new ArrayList<Integer>(); // こども人数
    ...
    private int                timeFromHour       = 0;
    private int                timeFromMin        = 0;
    private int                timeToHour         = 0;
    ...
    {
        return this.numAdultList;
    }

    public ArrayList<Integer> getNumChildList()
    {
        return this.numChildList;
    }
    ...
    public void setNumAdultList(int numAdult)
    {
        this.numAdultList.add( numAdult );
    }

    public void setNumChildList(int numChild)
    {
        this.numChildList.add( numChild );
    }
    ...
    {
        this.remarksList.add( remarksList );
    }
    ...
    public void setTel1List(String tel1List)
    {
        this.tel1List.add( tel1List );
    }
