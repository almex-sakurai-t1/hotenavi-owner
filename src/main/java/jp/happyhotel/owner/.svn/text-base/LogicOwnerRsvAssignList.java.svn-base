 ...
 */
public class LogicOwnerRsvAssignList implements Serializable
{
    ...
    private ArrayList<String>   parkingList           = new ArrayList<String>(); // 車の利用
    private ArrayList<String>   remarksList           = new ArrayList<String>(); // 備考
    private ArrayList<String>   demandsList           = new ArrayList<String>(); // 要望
     ...
     * @throws Exception
     */
    public boolean getHotelInfo(FormOwnerRsvAssignList frm) throws Exception
    {
        boolean isResult;
        String query = "";
     ...
     * @throws Exception
     */
    public boolean getData(FormOwnerRsvAssignList frm, int pageCnt, String mode) throws Exception
    {
        ...
        try
        {
            ...
            Logging.info( "[LogicOwnerRsvAssignList.getData()] id:" + this.hotelId );
            ...
            if ( result != null )
            {
                ...
                while( result.next() )
                {
                    ...
                    this.setOptionList( getOption( connection, result.getInt( "id" ), result.getString( "reserve_no" ) ) );
                    ...
                    if ( result.getInt( "parking" ) == ReserveCommon.PRKING_USED_USE )
                    {
                        ...
                        {
                            // 台数指定
                            this.setParkingList( String.format( "%s台", result.getInt( "parking_count" ) ) );
                        }
                        else
                        {
                            // 台数指定なし
                            this.setParkingList( "有" );
                        }
                    }
                    else
                    {
                        // 車なし
                        this.setParkingList( "無" );
                    }
                    this.setDemandsList( result.getString( "demands" ) );
                    this.setRemarksList( result.getString( "remarks" ) );
                ...
                if ( mode.equals( "ALL" ) )
                {
                    ...
                    for( i = 0 ; i < intMaxCnt - 1 ; i++ )
                    {
                        ...
                        frm.setParkingList( this.parkingList.get( i ) );
                        frm.setDemandsList( this.demandsList.get( i ) );
                        frm.setRemarksList( this.remarksList.get( i ) );
                    }
    ...
    private String getOption(Connection connection, int id, String reserve_no)
    {
        ...
        {
            Logging.error( "[LogicOwnerRsvAssignList.getOption] Exception=" + e.toString() );
        }
        finally
        {
    ...
    public void setDemandsList(String demandsList)
    {
        this.demandsList.add( demandsList );
    }

    public ArrayList<String> getDemandsList()
    {
        return demandsList;
    }
    ...
    {
        this.parkingList.add( parkingList );
    }

    public ArrayList<String> getParkingList()
    {
        return parkingList;
    }
