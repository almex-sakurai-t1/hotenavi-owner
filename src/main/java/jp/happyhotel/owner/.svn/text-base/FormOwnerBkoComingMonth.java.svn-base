...
public class FormOwnerBkoComingMonth
{
    ...
    private ArrayList<String>  rscAmountList    = new ArrayList<String>(); // ã‡äz
    ...
    private ArrayList<Integer> rsvAmountNumList = new ArrayList<Integer>(); // ã‡äz
