/*
 * @(#)DataMasterQuestion.java 1.00 2008/05/12 Copyright (C) ALMEX Inc. 2007 アンケート回答マスタ取得クラス
 */
 ...
 */
public class DataQuestionAnswer implements Serializable
{
     ...
     */
    public boolean getData(int questionId, int questionNo, int seq)
    {
        int count;
        String query;
        ...
        query = "SELECT * FROM hh_question_answer WHERE question_id= ? AND question_no = ?";
    ...
    public boolean insertData()
    {
        ...
        query = "INSERT hh_question_answer SET";
     ...
     * @return 処理結果(TRUE:正常,FALSE:異常)
     */
    public boolean updateData(int questionId, int questionNo, int seq)
    {
        int result;
        boolean ret;
        String query;
        ...
        query = "UPDATE hh_question_answer SET";
        query = query + " answer_branch = ?,";
        query = query + " answer_branch_sub = ?,";
        query = query + " answer_text = ?,";
        query = query + " answer_date = ?,";
