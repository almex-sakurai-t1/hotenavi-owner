...
if  (hotelid.compareTo("all") == 0)
{
    ...
    int    data_type_i = Integer.parseInt(data_type);
    data_type_i = data_type_i + 200;
    ...
    if( id.compareTo("0") != 0 )
    {
        ...
        query = query + " AND data_type=" + data_type_i;
    ...
    String    col_disp_idx = request.getParameter("col_disp_idx");
    if       (col_disp_idx == null) col_disp_idx = "0";
    ...
    if( id.compareTo("0") == 0 )
    {
        ...
        query = query + "data_type="    + data_type_i + ", ";
    ...
    else
    {
        ...
        query = query + "disp_idx="     + Integer.parseInt(col_disp_idx) + ", ";
    ...
    if( id.compareTo("0") != 0 )
    {
        query = query + " WHERE hotelid='" + hotelid + "' AND data_type=" + data_type_i + " AND id=" + id;
    }
...
%>
                  ...
                  <tr>
                    <td class="size12"><form action="price_list.jsp?HotelId=<%= hotelid %>" method="POST">
