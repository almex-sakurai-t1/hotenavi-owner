            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td>
                  ...
                  <form name=form1 method=post action="menu_mobilefree_input.jsp">
                  ...
                  <tr align="left">
                    <td height="24" bgcolor="#666666"><strong><font color="#FFFFFF">&nbsp;携帯・スマホ　フリーエリア</font></strong>
					</td>
                  </tr>
				<tr bgcolor="#FFFFFF">
...
%>
              <tr>
                ...
                <td height="30" align="center" valign="middle" bgcolor="#969EAD">
                  <form action="menu_mobilefree_delete.jsp?HotelId=<%= hotelid %>" method="POST">
