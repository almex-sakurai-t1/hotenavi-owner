...
if  (hotelid.compareTo("all") == 0)
{
    ...
    else
    {
        ...
        query = query + "msg2_title='"  + ReplaceString.SQLEscape(request.getParameter("col_msg2_title")) + "', ";
        ...
        query = query + "msg6='"        + ReplaceString.SQLEscape(request.getParameter("col_msg6")) + "', ";
    ...
    if( id.compareTo("0") != 0 )
    {
        query = query + " WHERE hotelid='" + hotelid + "' AND data_type=101 AND id=" + id;
    }
...
%>
                  ...
                  <tr>
                    <td class="size12"><form action="service_list.jsp?HotelId=<%= hotelid %>" method="POST">
