...
function MM_openInput(input,hotelid,data_type,id){
  if( input == 'input' )
  {
    document.form1.target = '_self';
    document.form1.action = 'price_edit_input.jsp?HotelId='+hotelid+'&DataType='+data_type+'&Id='+id;
  }
  if (document.form1.col_title.value != '')
  {
