...
if  (hotelid.compareTo("all") == 0)
{
    ...
    query = "DELETE FROM hotenavi.menu_config WHERE hotelid='" + hotelid + "' AND data_type=" + data_type + " AND id=" + id;
...
<%
if (sid.compareTo("all") == 0)
{
%>
                  <tr>
                    <td class="size12"><form action="menu_config_list_all.jsp?DataType=<%= data_type %>&DispType=0&SortType=0" method="POST">
