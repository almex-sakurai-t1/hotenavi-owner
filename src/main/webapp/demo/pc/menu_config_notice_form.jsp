...
if  (hotelid.compareTo("all") == 0)
{
    ...
    if( result.next() != false )
    {
        ...
        title       = ReplaceString.HTMLEscape(result.getString("title"));
        msg         = ReplaceString.HTMLEscape(result.getString("msg"));
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td>
                  ...
                  <form name=form1 method=post action="menu_config_notice_input.jsp">
                  ...
                  <tr align="left">
                    <td class="size12">
						<input name="disp_flg" type=radio value="0" <% if (disp_flg == 0){%>checked<%}%>>非表示
						<input name="disp_flg" type=radio value="1" <% if (disp_flg == 1){%>checked<%}%>>表示<br><br>
                  ...
                  <tr align="left">
                    <td height="24" bgcolor="#666666"><strong><font color="#FFFFFF">&nbsp;告知タイトル</font></strong></td>
                  </tr>
                  <tr align="left">
                  ...
                  <tr align="left">
                    <td height="24" bgcolor="#666666"><strong><font color="#FFFFFF">&nbsp;告知文</font></strong>
					</td>
                  </tr>
				<tr bgcolor="#FFFFFF">
				...
				<tr align="left" bgcolor="#FFFFFF">
					<td class="honbuntitlebar_text">
						<div class="honbun_margin" style="float:left;clear:both;">
							<textarea id="col_msg1" name=col_msg1 rows=10 cols=100 onfocus="ColFunc(1,'<%=hotelid%>',0);get_pos(col_msg1);" onkeyup="ColFunc(1,'<%=hotelid%>',0);get_pos(col_msg1);" onmouseup="get_pos(col_msg1);" onmousedown="ColFunc(1,'<%=hotelid%>',0);" onblur="dispArea1.innerHTML='';"><%= msg.replace("\"","&quot;") %></textarea>
...
if( document.getElementById("col_msg1").setSelectionRange ){
  ...
  bl=1;
				...
				<tr align="left">
                  ...
                  <tr align="left">
                    <td height="24" bgcolor="#666666"><strong><font color="#FFFFFF">&nbsp;告知対象コンテンツ</font></strong></td>
                  </tr>
                  <tr align="left">
                    <td class="size12">
					メニューのリンク以外で、告知文を表示するコンテンツ(.jspを省き、[,]区切りで列記）
					<input name="col_contents" type="text" size="100" value="<%= contents %>" ></td>
                  </tr>
...
%>
              <tr>
                ...
                <td height="30" align="center" valign="middle" bgcolor="#969EAD">
                  <form action="menu_config_notice_delete.jsp?HotelId=<%= hotelid %>" method="POST">
