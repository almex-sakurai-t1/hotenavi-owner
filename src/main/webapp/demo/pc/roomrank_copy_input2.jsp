...
<%
    ...
    query_ck = "SELECT * FROM roomrank WHERE hotelid='" + hotelid + "'";
...
if (error_flag)
{
    ...
    query = "SELECT * FROM roomrank WHERE hotelid='" + hotelidinput + "'";
    ...
    while( result.next() != false )
    {
       ...
       end_date = (yy+1900)*10000 + (mm+1)*100 + dd;
        ...
        query = query + "rank_name='"     + ReplaceString.SQLEscape(result.getString("rank_name"))       + "', ";
        ...
        query = query + "system_mobile='" + ReplaceString.SQLEscape(result.getString("system_mobile")) + "', ";
        query = query + "title_class='"   + ReplaceString.SQLEscape(result.getString("title_class")) + "', ";
        ...
        query = query + "sync_flag="      + result.getInt("sync_flag") + ", ";
	    	query = query + "disp_index="      + result.getInt("disp_index");
        prestate = connection.prepareStatement(query);
