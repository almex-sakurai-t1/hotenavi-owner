...
if (error_flag)
{
    query = "SELECT * FROM equipment WHERE hotelid='" + hotelidinput + "'";
    ...
    while( result.next() != false )
    {
       ...
       query = query + "disp_idx="     + result.getInt("disp_idx")    + ", ";
       query = query + "disp_flg="     + result.getInt("disp_flg")    + ", ";
       query = query + "start_date="   + start_date  + ", ";
       query = query + "end_date="     + end_date    + ", ";
       query = query + "equipment_name='"       + ReplaceString.SQLEscape(result.getString("equipment_name"))       + "', ";
       query = query + "class='"  + ReplaceString.SQLEscape(result.getString("class")) + "', ";
       query = query + "class_detail='"  + ReplaceString.SQLEscape(result.getString("class_detail")) + "', ";
       query = query + "detail='"        + ReplaceString.SQLEscape(result.getString("detail")) + "', ";
       query = query + "memo_all='"      + ReplaceString.SQLEscape(result.getString("memo_all")) + "', ";
       query = query + "memo_limit='"    + ReplaceString.SQLEscape(result.getString("memo_limit")) + "', ";
       query = query + "memo_all_mobile='"      + ReplaceString.SQLEscape(result.getString("memo_all_mobile")) + "', ";
       query = query + "memo_limit_mobile='"    + ReplaceString.SQLEscape(result.getString("memo_limit_mobile")) + "', ";
       ...
       query = query + "limit_name='"    + ReplaceString.SQLEscape(result.getString("limit_name")) + "' ";
