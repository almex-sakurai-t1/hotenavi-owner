...
if  (hotelid.compareTo("all") == 0)
{
    ...
    String    title = "スマートフォンサイトはこちら";
    String    msg   = "";
    int       disp_idx = 1;
    String    decoration= "サイト制作・運営<br><a href=\"https://www.almex.jp\" target=\"_blank\"><img border=\"0\" src=\"https://www.hotenavi.com/contents/common/img/almex_logo01.gif\" alt=\"アルメックス\"></a><br><a href=\"https://www.almex.jp\" target=\"_blank\">>>アルメックスへ</a>";
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td>
                  ...
                  <form name=form1 method=post action="menu_config_qredit_input.jsp">
  ...
  bl=1;
				...
				<tr align="left">
                  ...
                  <tr align="left">
					...
					<textarea name="col_decoration" rows=3 cols=120><%= decoration %></textarea></td>
                  </tr>
...
%>
              <tr>
                ...
                <td height="30" align="center" valign="middle" bgcolor="#969EAD">
                  <form action="menu_config_qredit_delete.jsp?HotelId=<%= hotelid %>" method="POST">
