...
%>
<a href="<%= response.encodeURL("allstoresales.jsp?Year="+(target_date/10000)+"&Month="+(target_date/100%100)+"&Day="+(target_date%100)) %>">前日</a>
<%
  }
%>
<%
...
%>
<a href="<%= response.encodeURL("allstoresales.jsp?Year="+(target_date/10000)+"&Month="+(target_date/100%100)+"&Day="+(target_date%100)) %>">前週</a>
<%
  }
%>
<%
...
%>
<a href="<%= response.encodeURL("allstoresales.jsp?Year="+(target_date/10000)+"&Month="+(target_date/100%100)+"&Day="+(target_date%100)) %>">前月</a>
<%
  }
%>
<%
...
%>
<a href="<%= response.encodeURL("allstoresales.jsp?Year="+(target_date/10000)+"&Month="+(target_date/100%100)+"&Day="+(target_date%100)) %>">前年</a>
<%
  }
%>
</div>
...
%>
<a href="<%= response.encodeURL("allstoresales.jsp?Year="+(target_date/10000)+"&Month="+(target_date/100%100)+"&Day="+(target_date%100)) %>">翌日</a>
<%
  }
%>
<%
...
%>
<a href="<%= response.encodeURL("allstoresales.jsp?Year="+(target_date/10000)+"&Month="+(target_date/100%100)+"&Day="+(target_date%100)) %>">翌週</a>
<%
  }
%>
<%
...
%>
<a href="<%= response.encodeURL("allstoresales.jsp?Year="+(target_date/10000)+"&Month="+(target_date/100%100)+"&Day="+(target_date%100)) %>">翌月</a>
<%
  }
%>
<%
...
%>
<a href="<%= response.encodeURL("allstoresales.jsp?Year="+(target_date/10000)+"&Month="+(target_date/100%100)+"&Day="+(target_date%100)) %>">翌年</a>
<%
  }
%>
</div>
