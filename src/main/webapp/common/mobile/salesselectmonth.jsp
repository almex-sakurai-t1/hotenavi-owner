...
%>
<a href="<%= response.encodeURL(Contents + ".jsp?HotelId=" + hotelid + "&Year="+(target_date/10000)+"&Month="+(target_date/100%100)+"&Day=0") %>">前年</a>
<%
  }
%>
<%
...
%>
<a href="<%= response.encodeURL(Contents + ".jsp?HotelId=" + hotelid + "&Year="+(target_date/10000)+"&Month="+(target_date/100%100)+"&Day=0") %>">前月</a>
<%
  }
%>
<%
...
%>
<a href="<%= response.encodeURL(Contents + ".jsp?HotelId=" + hotelid + "&Year="+(target_date/10000)+"&Month="+(target_date/100%100)+"&Day=0") %>">翌月</a>
<%
  }
%>
<%
...
%>
<a href="<%= response.encodeURL(Contents + ".jsp?HotelId=" + hotelid + "&Year="+(target_date/10000)+"&Month="+(target_date/100%100)+"&Day=0") %>">翌年</a>
<%
  }
%>
</div>
