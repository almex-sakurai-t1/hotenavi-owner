...
function ColFunc(colno,hotelid,data_type) {
    ...
    {
      case 1:
        source = document.getElementById("col_msg1").value;
        break;
      case 2:
        source = document.getElementById("col_msg2").value;
        break;
      case 3:
        source = document.getElementById("col_msg3").value;
        break;
      case 4:
        source = document.getElementById("col_msg4").value;
        break;
      case 5:
        source = document.getElementById("col_msg5").value;
        break;
      case 6:
        source = document.getElementById("col_msg6").value;
        break;
      case 7:
        source = document.getElementById("col_msg7").value;
        break;
      case 8:
        source = document.getElementById("col_msg8").value;
        break;
      default:
        break;
    }
    ...
    {
        source  = source.replace(/src="image/g, "src=\"https://hotenavi.com/" + hotelid + "/image");
    }
    ...
    source     = source.replace(/%>%/g, ">");
    source     = source.replace(/%KEYWORD%/g, document.form1.key_word.value);
    source     = source.replace(/%NAME%/g, document.form1.hname.value);
    source     = source.replace("[unsubscribe]", document.form1.unsubscribe_url.value);
    switch(colno)
    {
      case 1:
