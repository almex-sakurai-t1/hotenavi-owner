...
function setEndDtm() {
	...
	var hoursc = date.getHours();
	var minutesc = date.getMinutes();

	form1.col_end_yy.value = yearc;
	form1.col_end_mm.value = ("00" + monthc).slice(-2);
	form1.col_end_dd.value = ("00" + dayc).slice(-2);
	
	form1.col_end_hour.value = ("00" + hoursc).slice(-2);
	form1.col_end_minute.value = ("00" + minutesc).slice(-2);
