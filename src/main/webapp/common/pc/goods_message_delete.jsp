...
<%
    ...
    query = "DELETE FROM edit_event_info WHERE hotelid='" + hotelid + "' AND id=?";

    // SQLクエリーの実行
    int result = db.execUpdate(query,id);
...
%>
                  ...
                  <tr>
                    <td class="size12"><form action="goods_message.jsp?HotelId=<%= hotelid %>" method="POST">
