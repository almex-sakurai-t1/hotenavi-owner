...
<%
	        ...
	        query = query + " INNER JOIN owner_user_hotel ";
	        query = query + " ON hotel.hotel_id = owner_user_hotel.accept_hotelid";
	        query = query + " AND owner_user_hotel.userid = ?";
	        query = query + " AND owner_user_hotel.hotelid = ?";
	        query = query + " WHERE hotel.plan IN (1,2)";
...
%>
<jsp:include page="salescomparedisp_calendardisp.jsp" flush="true" >
