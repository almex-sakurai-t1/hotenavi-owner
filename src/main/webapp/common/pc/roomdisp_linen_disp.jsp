...
<%
    ...
    for( i = 0 ; i < count ; i++ )
    {
        ...
        // 作業班
        roomtag[x][y][z] = roomtag[x][y][z] + ownerinfo.LinenGroup[i] + "</B><BR><BR>";
        // 照明１
        if( ownerinfo.EquipActMode[i][1] == 1 && type != 2  && type != 3)
        {
        ...
        // 空調
        if( ownerinfo.EquipActMode[i][9] == 1 && type != 2  && type != 3)
        {
        ...
        // 部屋換気扇
        if( ownerinfo.EquipActMode[i][5] == 0 && type != 2  && type != 3)
        {
        ...
        // 風呂換気扇
        if( ownerinfo.EquipActMode[i][6] == 0 && type != 2  && type != 3 )
        {
        ...
        // 部屋窓
        if( ownerinfo.EquipActMode[i][4] == 0 && type != 2  && type != 3 )
        {
        ...
        // アラーム
        if( ownerinfo.EquipActMode[i][15] == 0 && type != 2 && type != 3)
        {
            roomtag[x][y][z] = roomtag[x][y][z] + "<IMG SRC=/common/pc/image/alarm.gif width=14 height=14> " + ownerinfo.EquipStatusData[i][4];
        }
        else
        {
            roomtag[x][y][z] = roomtag[x][y][z] + "<IMG SRC=/common/pc/image/blank.gif width=14 height=14> ";
        ...
        // 室温
        if( ownerinfo.EquipActMode[i][16] == 0 && type != 2  && type != 3 )
        {
            roomtag[x][y][z] = roomtag[x][y][z] + "<IMG SRC=/common/pc/image/roomtemp.gif width=14 height=14> " + ownerinfo.EquipStatusData[i][4];
        }
        else
        {
            roomtag[x][y][z] = roomtag[x][y][z] + "<IMG SRC=/common/pc/image/blank.gif width=14 height=14> ";
