...
<%
        ...
        while( ret != false )
        {
            ...
            ownerinfo.sendPacket0116(1, hotelid);
            ownerinfo.sendPacket0118(1, hotelid);
            ownerinfo.sendPacket0124(1, hotelid);
            if(ownerinfo.TexSupplyDate[0]==0)           TexExist      = false;
%>
<jsp:include page="roomdisp_linen_disp.jsp" flush="true" >
...
<%
    ...
    // 指定店舗のみ取得
        ...
        ownerinfo.sendPacket0116(1, selecthotel);
        ownerinfo.sendPacket0118(1, selecthotel);
