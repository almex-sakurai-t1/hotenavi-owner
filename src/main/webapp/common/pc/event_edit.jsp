...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td valign="top">
      ...
      <%-- 現在登録されているイベント情報表示 --%>
      <jsp:include page="event_edit_nowtopic.jsp" flush="true" />
      <%-- 現在登録されているイベント情報表示ここまで --%>
  ...
  <tr>
    <td align="center" valign="middle" class="size10"><img src="../../common/pc/image/imedia.gif" width="63" height="18"><img src="../../common/pc/image/spacer.gif" width="12" height="10" align="absmiddle">Copyright&copy; almex
