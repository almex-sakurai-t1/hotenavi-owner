...
<%
    ...
    final String query = "DELETE FROM goods_category WHERE hotelid = ? AND category_id = ? AND seq = ?";
    prestate    = connection.prepareStatement(query);
    prestate.setString(1,hotelid);
    prestate.setInt(2, cqtegory_id);
...
%>
                  ...
                  <tr>
                    <td class="size12"><form action="goods_list.jsp?HotelId=<%= hotelid %>&CategoryId=<%= category_id %>" method="POST">
