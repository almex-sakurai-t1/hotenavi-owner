...
<%
    ...
    query = "DELETE FROM edit_event_info WHERE hotelid=? AND data_type=? AND id=?";
    prestate          = connection.prepareStatement(query);
    prestate.setString(1, hotelid);
    prestate.setInt(2, data_type);
    prestate.setInt(3, Integer.parseInt(id));
    int result_delete = prestate.executeUpdate();
...
%>
                  ...
                  <tr>
                    <td class="size12"><form action="qaedit_message.jsp?HotelId=<%= hotelid %>" method="POST">
