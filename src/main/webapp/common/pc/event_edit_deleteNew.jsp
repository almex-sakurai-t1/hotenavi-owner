...
<%@ page import="com.hotenavi2.common.*" %><%@ page import="jp.happyhotel.common.DBSync" %>
...
<%
    ...
    {
        if ( date != null && !CheckString.numAlphaCheck( date ) )
        {
    ...
    try
    {
        ...
        query = "DELETE FROM hotenavi.edit_event_info WHERE hotelid=? AND data_type=? AND id=?";
...
%>
                  ...
                  <tr>
                    <td class="size12"><form action="event_list.jsp?HotelId=<%= hotelid %>&DataType=<%= data_type %>" method="POST">
