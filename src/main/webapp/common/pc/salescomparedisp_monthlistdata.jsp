...
%>
            <tr height="24px">
              <td align="right" valign="middle" class="size14 tableLW" nowrap colspan=2>　</td>
...
%>
            <tr height="24px">
              <td align="left" valign="middle"  class="size14">
                <input name="CompareStartYear"  type="hidden" value="<%=startYear%>">
                <input name="CompareStartMonth" type="hidden" value="<%=startMonth%>">
                <input name="CompareStartDay"   type="hidden" value="<%=paramDay%>">
<%
    if( endYear != null && endMonth != null && endDay != null )
    {
%>
                <input name="CompareEndYear"    type="hidden" value="<%=endYear%>">
                <input name="CompareEndMonth"   type="hidden" value="<%=endMonth%>">
                <input name="CompareEndDay"     type="hidden" value="<%=endDay%>">
<%
    }
%>
                &nbsp;
