...
<%
    ...
    try
    {
        query = "SELECT host_kind,name FROM hotel WHERE hotel_id=?";
    ...
    for( i = 0 ; i < count ; i++ )
    {
        ...
        // メンバーID
        if( ownerinfo.StateCustomId[i] != null && ownerinfo.StateCustomId[i].compareTo("") != 0 )
        {
            // メンバーイベントあり？
            if( ownerinfo.StateCustomEvent[i] != 0 )
            {
                roomtag[x][y][z] = roomtag[x][y][z] + "<IMG SRC=../../common/pc/image/customevent.gif width=16 height=16> ";
            }
            else
            {
                roomtag[x][y][z] = roomtag[x][y][z] + "<IMG SRC=../../common/pc/image/card.gif width=16 height=16> ";
            }
        }
        else
        {
        ...
        // 警告情報
        if(  ownerinfo.StateCustomWarning != null && ownerinfo.StateCustomWarning[i] != 0 )
        {
            roomtag[x][y][z] = roomtag[x][y][z] + "<IMG SRC=../../common/pc/image/keikoku.gif width=16 height=16> ";
        }
        else
        {
            roomtag[x][y][z] = roomtag[x][y][z] + "<IMG SRC=../../common/pc/image/blank.gif width=16 height=16> ";
        ...
        // 連絡情報
        if( ownerinfo.StateCustomContact != null && ownerinfo.StateCustomContact[i] != 0 )
        {
            roomtag[x][y][z] = roomtag[x][y][z] + "<IMG SRC=../../common/pc/image/contact.gif width=16 height=16> ";
        }
        else
        {
            roomtag[x][y][z] = roomtag[x][y][z] + "<IMG SRC=../../common/pc/image/blank.gif width=16 height=16> ";
        ...
        // 景品情報
        if( ownerinfo.StateCustomPresent != null && ownerinfo.StateCustomPresent[i] != 0 )
        {
            roomtag[x][y][z] = roomtag[x][y][z] + "<IMG SRC=../../common/pc/image/present.gif width=16 height=16> ";
        }
        else
        {
            roomtag[x][y][z] = roomtag[x][y][z] + "<IMG SRC=../../common/pc/image/blank.gif width=16 height=16> ";
        ...
        // 冷蔵庫状態
        if( ownerinfo.StateRefUse != null && ownerinfo.StateRefUse[i] != 0 )
        {
            roomtag[x][y][z] = roomtag[x][y][z] + "<IMG SRC=../../common/pc/image/ref.gif width=16 height=16> ";
        }
        else
        {
            roomtag[x][y][z] = roomtag[x][y][z] + "<IMG SRC=../../common/pc/image/blank.gif width=16 height=16> ";
        ...
        // コンビニ状態
        if( ownerinfo.StateConveniUse != null && ownerinfo.StateConveniUse[i] != 0 )
        {
            roomtag[x][y][z] = roomtag[x][y][z] + "<IMG SRC=../../common/pc/image/conveni.gif width=16 height=16> ";
        }
        else
        {
            roomtag[x][y][z] = roomtag[x][y][z] + "<IMG SRC=../../common/pc/image/blank.gif width=16 height=16> ";
        ...
        // ドア状態
        if(  ownerinfo.StateDoor != null && ownerinfo.StateDoor[i] != 0 )
        {
            roomtag[x][y][z] = roomtag[x][y][z] + "<IMG SRC=../../common/pc/image/door.gif width=16 height=16> ";
        }
        else
        {
            roomtag[x][y][z] = roomtag[x][y][z] + "<IMG SRC=../../common/pc/image/blank.gif width=16 height=16> ";
        ...
        {
            roomtag[x][y][z] = roomtag[x][y][z] + "<BR><DIV style='float:right;clear:both'>";
  ...
  <tr>
    <td align="center" valign="top" bgcolor="#D0CED5">
      <table width="98%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td align="left" valign="top"><img src="../../common/pc/image/spacer.gif" width="100" height="6">
		  </td>
        </tr>
        <tr>
          <td align="left">
