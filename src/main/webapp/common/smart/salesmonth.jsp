...
<title>月計売上(<%= StringEscapeUtils.escapeHtml4(hotelid) %>)年月指定</title>
...
<li><a href="<%= response.encodeURL("salesdisp.jsp?HotelId=" + URLEncoder.encode(hotelid, "Windows-31J") + "&Day=0") %>">本月</a></li>
</ul>
<%-- 日付選択アイテムを表示します --%>
