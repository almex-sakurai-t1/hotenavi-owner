...
<title>現在タイムチャート(<%= StringEscapeUtils.escapeHtml4(hotelid) %>)</title>
...
<%
    ...
    {
%>
<h1 class="title">現在タイムチャート</h1>
<%-- ここで現在タイムチャート情報を取得します --%>
<jsp:include page="timechartget.jsp" flush="true" />
<%-- ここで現在タイムチャート情報を取得します（ここまで） --%>
<%-- 現在タイムチャート情報データの表示 --%>
<jsp:include page="timechartdispdata.jsp" flush="true" />
<%-- 現在タイムチャート情報データの表示ここまで --%>
<%
    }
    else
    {
