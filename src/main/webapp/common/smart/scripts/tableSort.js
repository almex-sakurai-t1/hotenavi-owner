...
TableSort.arrowNone = " <img height=16 width=8 src='../../common/smart/image/sort_done.png' alt=''>";
TableSort.arrowUp = " <img height=16 width=8 src='../../common/smart/image/sort_asc.png' alt='↑'>";
TableSort.arrowDown = " <img height=16 width=8 src='../../common/smart/image/sort_desc.png' alt='↓'>";
