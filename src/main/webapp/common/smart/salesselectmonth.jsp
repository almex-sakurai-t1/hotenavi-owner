...
<li class="some"><a href="<%= response.encodeURL(URLEncoder.encode(contents, "Windows-31J") + ".jsp?HotelId=" + URLEncoder.encode(hotelid, "Windows-31J") + "&Year="+(target_date/10000)+"&Month="+(target_date/100%100)+"&Day=0") %>">前年</a>
<%
    }
%>
<%
...
%>
<a href="<%= response.encodeURL(URLEncoder.encode(contents, "Windows-31J") + ".jsp?HotelId=" + URLEncoder.encode(hotelid, "Windows-31J") + "&Year="+(target_date/10000)+"&Month="+(target_date/100%100)+"&Day=0") %>">前月</a>
<%
    }
%>
<%
...
%>
<a href="<%= response.encodeURL(URLEncoder.encode(contents, "Windows-31J") + ".jsp?HotelId=" + URLEncoder.encode(hotelid, "Windows-31J") + "&Year="+(target_date/10000)+"&Month="+(target_date/100%100)+"&Day=0") %>">翌月</a>
<%
    }
%>
<%
...
%>
<a href="<%= response.encodeURL(URLEncoder.encode(contents, "Windows-31J") + ".jsp?HotelId=" + URLEncoder.encode(hotelid, "Windows-31J") + "&Year="+(target_date/10000)+"&Month="+(target_date/100%100)+"&Day=0") %>">翌年</a></li>
<%
    }
%>
</ul>
