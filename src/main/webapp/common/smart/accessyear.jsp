...
<title>ｻｲﾄｱｸｾｽ情報月別ｱｸｾｽ数(<%= StringEscapeUtils.escapeHtml4(hotelid) %>)</title>
...
<%
    ...
    {
%>
<h1 class="title">ｻｲﾄｱｸｾｽ情報-<font size="-1">月別ｱｸｾｽ数</font></h1>
<jsp:include page="accessyearget.jsp" flush="true" />
<%
    }
    else
    {
